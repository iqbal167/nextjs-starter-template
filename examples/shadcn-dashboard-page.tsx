            ...
            <div className="space-y-3">
              {filteredUsers.length > 0 ? (
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    Tidak ada pengguna yang ditemukan dengan kriteria pencarian "{searchTerm}"
                  </AlertDescription>
                </Alert>
              )}
            </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {[
                  { action: 'User login', user: 'John Doe', time: '2 menit lalu' },
                  { action: 'New user registered', user: 'Jane Smith', time: '15 menit lalu' },
                  { action: 'Profile updated', user: 'Bob Johnson', time: '1 jam lalu' },
                  { action: 'Password changed', user: 'Alice Brown', time: '3 jam lalu' },
                ].map((activity, index) => (
